...
{
    [DefaultEvent("Click")]
    public partial class MyButton2 : Button
    {
        #region attribute
        ...
        private void DrawBackGround(Graphics g)
        {
            ...
            Rectangle rectL = new Rectangle(1, 1, Width - 3, Height - 3);
            Rectangle rectS;
            ...
            switch (_ControlState)
            {
                case EnumControlState.Default:
                    ...
                    {
                        rectS = new Rectangle(1 + DefaultBorderWidth, 1 + DefaultBorderWidth, Width - 3 - DefaultBorderWidth, Height - 3 - DefaultBorderWidth);
                        GDIHelper.FillRectangle(g, rectL, DefaultBorderColor, true);
                        GDIHelper.FillRectangle(g, rectS, DefaultBackColor, true);
                    }
                    break;
                case EnumControlState.HeightLight:
                    rectS = new Rectangle(1 + HighLightBorderWidth, 1 + HighLightBorderWidth, Width - 3 - HighLightBorderWidth, Height - 3 - HighLightBorderWidth);
                    GDIHelper.FillRectangle(g, rectL, HighLightBorderColor, true);
                    GDIHelper.FillRectangle(g, rectS, HighLightBackColor, true);
                    break;
                case EnumControlState.Focused:
                    rectS = new Rectangle(1 + FocusedBorderWidth, 1 + FocusedBorderWidth, Width - 3 - FocusedBorderWidth, Height - 3 - FocusedBorderWidth);
                    GDIHelper.FillRectangle(g, rectL, FocusedBorderColor, true);
                    GDIHelper.FillRectangle(g, rectS, FocusedBackColor, true);
                    break;
            }
        }
